...
⚠️ 會議室相關詢問（有會議室嗎、會議室多少錢、可以訂會議室嗎）都歸類為「詢價」，由客服人員回覆並協助預約。
...
## 回傳 JSON 格式
{{
    "complexity": "SIMPLE" 或 "COMPLEX" 或 "BOOKING",
    "reason": "簡短說明判斷原因（10字內）",
    "suggested_intent": "預判的意圖類型（詢價|預約會議室|查詢預約|取消預約|客訴|閒聊|報修|其他）"
}}
"""
